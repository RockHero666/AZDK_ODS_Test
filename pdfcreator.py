...
class PdfFunTestReport(Pdf):
    ...
    def _add_accuracy_table(self, dtable : DataFrame):
        ...
        self.set_font(size=12)
        col_w = (9, 25, 25, 25, 14, 14, 14, 12, 12, 12)
    ...
    def addTitlePage(self
        ...
        self.addParagraph('Функциональные испытания МЗД АЗДК 1 проводились с использованием имитатора звездного неба ОДС-1' +
                         f' №{pds_num:03d}, проецировавшего на матрицу МЗД АЗДК 1 динамичные и статичные кадры звездного неба.', extra_lf=6)
...
if __name__ == "__main__":
    ...
    text = [
    ['Время', 'Код', 'Команда', 'Устройство'],
    ['15:59:12', ' ','Начало тестирования', '', ''],
    ['15:59:13', '22', 'Изменение шаблона имени файла журнала', 'ASC', ''],
    ['15:59:13', '49', 'Режим автономной работы', 'AC', ''],
    ['15:59:14', '6', 'Установить ориентацию (GCRS)', 'PSC', ''],
    ['15:59:14', '10', 'Установить угловую скорость (GCRS),', 'PSC', ''],
    ['15:59:14', '7', 'Установка угл.скор.', 'AC', ''],
    ['15:59:14', '48', 'Режим ожидания', 'AC', ''],
